...
### Cloud, Dados, Testes & Ferramentas
...
`Cloudflare Workers` · `D1` · `Drizzle ORM` · `Playwright` · `REST APIs` · `RBAC` · `CI/CD` · `Responsive Design`
...
![Snake animation](https://raw.githubusercontent.com/thiago-t1/thiago-t1/output/github-contribution-grid-snake-dark.svg)
...
- **SaaS e plataformas web:** experiências completas, multi-tenant e responsivas
- **APIs e backend:** regras de negócio, autenticação, autorização e persistência
- **Cloud & serverless:** aplicações distribuídas e eficientes na edge
- **Cybersecurity:** laboratórios educacionais, defesa de aplicações e DevSecOps
- **Qualidade:** automação de testes, documentação e arquitetura sustentável
